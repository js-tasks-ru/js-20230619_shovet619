...
export default class SortableTable extends SortableTableV2 {
  ...
  initialize() {
    ...
    const rootElement = super.createRootElement(headerElement, tableElement);
  ...
  updateTable(data) {
    const rowsTemplate = data.map(item => super.createTableRow(item)).join("");
    this.subElements.body.innerHTML = rowsTemplate;
  }
